...
Senior Software Engineer at Salad Technologies.
...
<div class="card" style="margin: auto; width: 75%; box-shadow: 2px 2px 2px rgba(0,0,0,0.25);">
    <img src="/images/about-gameboy-asm.jpg" class="card-img-top" width="100%" />
</div>

<br>

For the rest of the year, when I'm not at the computer, you can find me outside tending to my gardens and 
fruit trees. Permaculture is my greater passion and my goal is to one day start my own nursery.

<div class="card" style="margin: auto; width: 75%; box-shadow: 2px 2px 2px rgba(0,0,0,0.25);">
    <img src="/images/about-permaculture.jpg" class="card-img-top" width="100%" />
</div>